...
export const TestimonialsSection = () => {
  return <section className="py-20 px-4 bg-gradient-to-br from-purple-50 to-pink-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial, index) => <div key={index} className="bg-white rounded-2xl shadow-xl p-8 relative">
              ...
              <div className="border-t pt-4">
                ...
                {testimonial.credential && <p className="text-sm text-gray-600">{testimonial.credential}</p>}
              </div>
            </div>)}
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              <p className="text-4xl font-bold text-pink-600 mb-2">90%</p>
